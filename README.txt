The file run_analysis correspond to the code that allowds us to achieve the results asked in the activity. In order to do that, you shoul change your working directory where you have store the datasets that are needed.
